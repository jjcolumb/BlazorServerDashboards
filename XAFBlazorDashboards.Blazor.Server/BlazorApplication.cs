...
namespace XAFBlazorDashboards.Blazor.Server {
    public partial class XAFBlazorDashboardsBlazorApplication : BlazorApplication {
        public XAFBlazorDashboardsBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XAFBlazorDashboardsBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
